package com.nordstrom.kafka.connect.protobuf;
...
public class ProtobufData {
    ...
    public ProtobufData(Class<? extends com.google.protobuf.GeneratedMessageV3> clazz, String legacyName, boolean useConnectSchemaMap ) {
    ...
    public SchemaAndValue toConnectData(byte[] value) {
    ...
    public Schema toConnectSchema(Message message) {
